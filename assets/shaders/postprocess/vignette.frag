...
void main(){
    ...
    // Comment:
    // Apply equation: y = 2x - 1, on each coordinate, where y is the new coordinate value in NDC (x`, y`, z`), 
    // and x is the original coordinate value (x, y, z) in the texture coordinates.
